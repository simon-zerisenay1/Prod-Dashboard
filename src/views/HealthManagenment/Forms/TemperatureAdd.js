...
//   }
//   // for the Attachment Will be here
//   // AddAnimalsTemperature will be here
//   const AddAnimalsTemperature = async (e, file, fileName) => {
//     e.preventDefault()
//     setIsLoader('block')
//     let theSendData = {}
...
//       }
//       const res = await fetch(`${NODEAPIURL}/admin/AddAnimalsTemperature`, requestOptions)
//       const resJson = await res.json()
//       setIsLoader('none')
//       if (res.status === 200) {
//         // console.log(resJson)
...
//         body: JSON.stringify({ formID, AutoID, formType: 'temperatures' }),
//       }
...
//           {ListAddonsFields ? <ListAddonsFieldPage for_form="animalTemparature" /> : ''}
//         </div>
//       </div>
//       <CCol lg={12}>
...
//                   className=""
//                   onSubmit={(e) => {
//                     return AddAnimalsTemperature(e)
//                   }}
...
//                                   document.getElementById(`tf_ani_${s.ani_id}`).checked =
//                                     e.target.checked
//                                 }
//                                 return s
//                               })
...
//                           formID={formID}
//                           description={`Check ${FormsData.period} Animal Temperature`}
//                         />
//                       </>
//                     ) : (
//                       ''

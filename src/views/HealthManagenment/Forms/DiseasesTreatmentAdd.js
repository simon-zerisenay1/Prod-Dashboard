...
//     <ListAddonsFieldData for_form="animalDisTri" data_id={ForID} returnData={setAddonsFieldData} />,
//   )
...
//   // AddAnimalsDiseasesTreatment will be here
//   const AddAnimalsDiseasesTreatment = async (e) => {
//     e.preventDefault()
//     setIsLoader('block')
//     let theSendData = {}
...
//           {ListAddonsFields ? <ListAddonsFieldPage for_form="animalDisTri" /> : ''}
//         </div>
//       </div>
//       <CCol lg={12}>
...
//                   Add Diseases/Treatment History
//                   <div
//                     style={{
//                       float: 'right',
...
//                   className=""
//                   onSubmit={(e) => {
//                     return AddAnimalsDiseasesTreatment(e)
//                   }}
...
//                                   document.getElementById(`dt_f_ani${s.ani_id}`).checked =
//                                     e.target.checked
//                                 }
//                                 return s
//                               })
...
//                         value={FormsData.observationDate}
//                         onChange={(e) => {
//                           HandleFormData(e.target.name, e.target.value)
//                         }}
...
//                         value={FormsData.observationTime}
//                         onChange={(e) => {
//                           HandleFormData(e.target.name, e.target.value)
//                         }}
...
//                         value={FormsData.treatmentDescription}
//                         onChange={(e) => {
//                           HandleFormData(e.target.name, e.target.value)
//                         }}
...
//                           formID={formID}
//                           description="Add Diseases/Treatment History"
//                         />
//                       </>
//                     ) : (
//                       ''

...
// import DataManualAdd from './WeightAdd'
...
//         <WeightImport setisImport={setisImport} FilterAnimalsList={FilterAnimalsList} />
//       </div>
//       <CCol xs={12} style={{ display: isImport ? 'none' : '' }}>
//         <h4 className="mb-3 mt-3">Weight List</h4>
//       </CCol>
...
//             setformID(0)
//             setAutoID(0)
//             document.getElementById('attachMentWF').value = ''
//             setisisAdd(true)
//             setisImport(true)
...
//                   document.getElementById(`wf_ani_${s.ani_id}`).checked = false
//                 }
//                 return s
//               })
...
//                             deleteAnimalHealthData(singi.formID, 'weights')
//                           }
//                         }}
//                       />
//                     </CTableDataCell>

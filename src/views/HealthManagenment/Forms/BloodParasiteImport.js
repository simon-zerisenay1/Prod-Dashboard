...
//         redirect: 'follow',
//       }
//       const res = await fetch(`${NODEAPIURL}/admin/importanimalsBloodParasite`, requestOptions)
...
//     <CRow>
//       <CCol lg={12}>
//         <h3 className="mb-3 mt-3">Add Blood Parasite</h3>
//       </CCol>
...
//                   <a
//                     download
//                     href={`${BASEWEBURL}/import/Blood_Parasite.csv`}

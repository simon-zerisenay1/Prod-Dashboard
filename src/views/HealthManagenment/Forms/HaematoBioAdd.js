...
//   // AddAnimalsHaematoBio will be here
//   const AddAnimalsHaematoBio = async (e) => {
//     e.preventDefault()
//     setIsLoader('block')
//     let theSendData = {}
...
//       }
//       const res = await fetch(`${NODEAPIURL}/admin/AddAnimalsHaematoBio`, requestOptions)
//       const resJson = await res.json()
//       setIsLoader('none')
//       if (res.status === 200) {
//         // console.log(resJson)
...
//         method: 'POST',
//         headers: headerAPI({ 'Content-Type': 'application/json' }),
//         body: JSON.stringify({ formID, AutoID, formType: 'haematobios' }),
//       }
...
//           {ListAddonsFields ? <ListAddonsFieldPage for_form="animalHaemato" /> : ''}
//         </div>
//       </div>
//       <CCol lg={12}>
...
//                                   document.getElementById(`hb_f_ani${s.ani_id}`).checked =
//                                     e.target.checked
//                                 }
//                                 return s
//                               })
...
//                           formID={formID}
//                           description="Add Haematology & Biochemistry"
//                         />
//                       </>
//                     ) : (
//                       ''

...
//         redirect: 'follow',
//       }
//       const res = await fetch(`${NODEAPIURL}/admin/importanimalsBodyExaminations`, requestOptions)
...
//     <CRow>
//       <CCol lg={12}>
//         <h3 className="mb-3 mt-3">Add Body Examinations</h3>
//       </CCol>
...
//                   <a
//                     download
//                     href={`${BASEWEBURL}/import/BodyExamination.csv`}

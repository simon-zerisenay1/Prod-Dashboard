...
// import BloodParasiteImport from './BloodParasiteImport'
// import DataManualAdd from './BloodParasiteAdd'
...
//     try {
//       const res = await fetch(`${NODEAPIURL}/admin/getanimalsBloodParasite`, {
//         method: 'POST',
...
//         <BloodParasiteImport setisImport={setisImport} FilterAnimalsList={FilterAnimalsList} />
//       </div>
//       <CCol xs={12} style={{ display: isImport ? 'none' : '' }}>
//         <h4 className="mb-3 mt-3">Blood Parasite History</h4>
//       </CCol>
...
//             setformID(0)
//             setAutoID(0)
//             document.getElementById('attachMentBP').value = ''
//             setisisAdd(true)
//             setisImport(true)
...
//                   document.getElementById(`bp_f_ani_${s.ani_id}`).checked = false
//                 }
//                 return s
//               })
...
//                             deleteAnimalHealthData(singi.formID, 'bloodparasites')
//                           }
//                         }}
//                       />
//                     </CTableDataCell>
...
//                     <CTableDataCell>{singi.doctor}</CTableDataCell>
//                     <CTableDataCell>{singi.contact}</CTableDataCell>
//                     <CTableDataCell>{singi.anaplasma}</CTableDataCell>
//                     <CTableDataCell>{singi.theileria}</CTableDataCell>
//                     <CTableDataCell>{singi.babesia}</CTableDataCell>
//                     <CTableDataCell>{singi.trypano}</CTableDataCell>
//                     <CTableDataCell>
//                       {singi.attachment &&

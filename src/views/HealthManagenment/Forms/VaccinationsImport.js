...
//         redirect: 'follow',
//       }
//       const res = await fetch(`${NODEAPIURL}/admin/importanimalsVaccinations`, requestOptions)
...
//     <CRow>
//       <CCol lg={12}>
//         <h3 className="mb-3 mt-3">Add Vaccination</h3>
//       </CCol>
...
//                   <a
//                     download
//                     href={`${BASEWEBURL}/import/Vaccination.csv`}

...
const AddFromSheet = ({ setisImport, FilterAnimalsList }) => {
  ...
  const uploadAttachment = async (e, file, fileName) => {
    ...
    try {
      ...
      const res = await fetch(`${NODEAPIURL}/admin/importanimalsHaematoBioImport`, requestOptions)
  ...
  return (
    <CRow>
      <CCol lg={12}>
        <h3 className="mb-3 mt-3">Add Haematology Biochemistry Results</h3>
      </CCol>
            ...
            <CRow className="mb-4">
              <CCol lg={6}>
                ...
                <p>
                  ...
                  <a
                    download
                    href={`${BASEWEBURL}/import/Haematology_Biochemistry.csv`}
